...
# Only modify the MAYA_SCRIPT_PATH if we're a registered Maya module.
# Otherwise assume the user will manually manage the path themselves.
if 'mayaHacks' in maya.cmds.moduleInfo(listModules=True):
